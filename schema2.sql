...
CREATE TABLE IF NOT EXISTS "blog_customuser" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "password" varchar(128) NOT NULL, "last_login" datetime NULL, "is_superuser" bool NOT NULL, "username" varchar(150) NOT NULL UNIQUE, "first_name" varchar(150) NOT NULL, "last_name" varchar(150) NOT NULL, "email" varchar(254) NOT NULL, "is_staff" bool NOT NULL, "is_active" bool NOT NULL, "date_joined" datetime NOT NULL, "session_id" char(32) NOT NULL UNIQUE, "created_at" datetime NOT NULL, "last_active" datetime NOT NULL);
CREATE TABLE IF NOT EXISTS "blog_customuser_groups" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "customuser_id" bigint NOT NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "group_id" integer NOT NULL REFERENCES "auth_group" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE TABLE IF NOT EXISTS "blog_customuser_user_permissions" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "customuser_id" bigint NOT NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "permission_id" integer NOT NULL REFERENCES "auth_permission" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE UNIQUE INDEX "blog_customuser_groups_customuser_id_group_id_ac5fda07_uniq" ON "blog_customuser_groups" ("customuser_id", "group_id");
CREATE INDEX "blog_customuser_groups_customuser_id_d062a394" ON "blog_customuser_groups" ("customuser_id");
CREATE INDEX "blog_customuser_groups_group_id_fb42ef5f" ON "blog_customuser_groups" ("group_id");
CREATE UNIQUE INDEX "blog_customuser_user_permissions_customuser_id_permission_id_bc5efb0d_uniq" ON "blog_customuser_user_permissions" ("customuser_id", "permission_id");
CREATE INDEX "blog_customuser_user_permissions_customuser_id_9c3bce41" ON "blog_customuser_user_permissions" ("customuser_id");
CREATE INDEX "blog_customuser_user_permissions_permission_id_48518076" ON "blog_customuser_user_permissions" ("permission_id");
CREATE TABLE IF NOT EXISTS "django_admin_log" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "object_id" text NULL, "object_repr" varchar(200) NOT NULL, "action_flag" smallint unsigned NOT NULL CHECK ("action_flag" >= 0), "change_message" text NOT NULL, "content_type_id" integer NULL REFERENCES "django_content_type" ("id") DEFERRABLE INITIALLY DEFERRED, "user_id" bigint NOT NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "action_time" datetime NOT NULL);
CREATE INDEX "django_admin_log_content_type_id_c4bce8eb" ON "django_admin_log" ("content_type_id");
CREATE INDEX "django_admin_log_user_id_c564eba6" ON "django_admin_log" ("user_id");
CREATE TABLE IF NOT EXISTS "filer_folderpermission" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "type" smallint NOT NULL, "everybody" bool NOT NULL, "can_edit" smallint NULL, "can_read" smallint NULL, "can_add_children" smallint NULL, "folder_id" integer NULL REFERENCES "filer_folder" ("id") DEFERRABLE INITIALLY DEFERRED, "group_id" integer NULL REFERENCES "auth_group" ("id") DEFERRABLE INITIALLY DEFERRED, "user_id" bigint NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE IF NOT EXISTS "filer_clipboard" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "user_id" bigint NOT NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE IF NOT EXISTS "filer_file" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "file" varchar(255) NULL, "_file_size" bigint NULL, "sha1" varchar(40) NOT NULL, "has_all_mandatory_data" bool NOT NULL, "original_filename" varchar(255) NULL, "name" varchar(255) NOT NULL, "description" text NULL, "uploaded_at" datetime NOT NULL, "modified_at" datetime NOT NULL, "is_public" bool NOT NULL, "folder_id" integer NULL REFERENCES "filer_folder" ("id") DEFERRABLE INITIALLY DEFERRED, "owner_id" bigint NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "polymorphic_ctype_id" integer NULL REFERENCES "django_content_type" ("id") DEFERRABLE INITIALLY DEFERRED, "mime_type" varchar(255) NOT NULL);
...
CREATE TABLE IF NOT EXISTS "filer_folder" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "name" varchar(255) NOT NULL, "uploaded_at" datetime NOT NULL, "created_at" datetime NOT NULL, "modified_at" datetime NOT NULL, "owner_id" bigint NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "parent_id" integer NULL REFERENCES "filer_folder" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE IF NOT EXISTS "blog_post" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "anon_uuid" char(32) NOT NULL, "title" varchar(100) NOT NULL, "city" varchar(100) NULL, "content" text NULL, "contact" text NULL, "description" text NOT NULL, "image" varchar(100) NULL, "date_posted" datetime NOT NULL, "like_count" integer unsigned NOT NULL CHECK ("like_count" >= 0), "ip_address" char(39) NULL, "author_id" bigint NOT NULL REFERENCES "blog_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "parent_post_id" bigint NULL REFERENCES "blog_post" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE INDEX "blog_post_author_id_dd7a8485" ON "blog_post" ("author_id");
CREATE INDEX "blog_post_parent_post_id_9771a384" ON "blog_post" ("parent_post_id");
